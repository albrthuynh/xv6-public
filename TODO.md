...
Week 1:
- [x] Purv: VGA framebuffer driver in xv6 kernel; pixel draw primitives (lines, rectangles, fill). 
...
- [x] Purv: Keyboard/mouse input routing to focused window.

Week 3:
- [x] Albert: File explorer (readdir integration), terminal window, 
- [x] Purv: wallpaper support, macOS-style dock/menu bar. 
